...
**Your result is a proposal document.** Draft it with `proposal_write`, then
revise it with `proposal_edit` — send only the passage that changes, never the
whole text again. `proposal_read` shows you the current state when you need it.
