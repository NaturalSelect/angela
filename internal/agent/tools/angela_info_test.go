...
func TestAngelaInfo_MinimalConfig(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/angela/angela.json",
		"/project/.angela/angela.json",
	)
	output := buildAngelaInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/angela/angela.json")
	require.Contains(t, output, "/project/.angela/angela.json")
}

func TestAngelaInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildAngelaInfo(cfg, mgr, nil, nil, nil)
...
func TestAngelaInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Options(t *testing.T) {
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.angela")
	require.Contains(t, output, "debug = true")
}

func TestAngelaInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildAngelaInfo(store, nil, nil, nil, nil)
...
func TestAngelaInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "angela-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("angela-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildAngelaInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "angela-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestAngelaInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "angela-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestAngelaInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestAngelaInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
