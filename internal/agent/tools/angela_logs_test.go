...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "angela.log")
...
func TestNewAngelaLogsTool(t *testing.T) {
	t.Parallel()
...
func TestAngelaLogs_HappyPath(t *testing.T) {
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 3})
...
func TestAngelaLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 0})
...
func TestAngelaLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestAngelaLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runAngelaLogs("/nonexistent/path/angela.log", AngelaLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestAngelaLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "angela.log")
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestAngelaLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "angela.log")
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 10})
...
func TestAngelaLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 1})
...
func TestAngelaLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestAngelaLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestAngelaLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestAngelaLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "angela.log")
...
func TestAngelaLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "angela.log")
...
func TestAngelaLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestAngelaLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestAngelaLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestAngelaLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runAngelaLogs(logFile, AngelaLogsParams{Lines: 5})
...
func TestAngelaLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
