...
// Source: github.com/modelcontextprotocol/go-sdk/mcp (interfaces: Connection)
//
// Generated by this command:
//
//	mockgen -destination=internal/agent/tools/mcp/mock_connection_test.go -package=mcp github.com/modelcontextprotocol/go-sdk/mcp Connection
//
...
func (m *MockConnection) Read(arg0 context.Context) (jsonrpc.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Read", arg0)
	ret0, _ := ret[0].(jsonrpc.Message)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockConnection) Write(arg0 context.Context, arg1 jsonrpc.Message) error {
	m.ctrl.T.Helper()
