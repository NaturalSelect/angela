...
- Reads up to {{ .DefaultReadLimit }} lines from the start by default; use offset and limit to read later sections. At most {{ .MaxReadSizeKB }}KB of file content is returned.
