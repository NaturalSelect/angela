...
func (c *errorCoordinator) LockSession(context.Context, string) (func(), bool) { return nil, false }
...
func (c *errorCoordinator) IsSessionBranch(string) bool                        { return false }
...
func (c *errorCoordinator) AskSideQuestion(context.Context, string, string) (string, error) {
	return "", nil
}
...
// RunComplete for the run's RunID. Without it, a `angela run` caller
