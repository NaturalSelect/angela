...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.updateSessionAgentAndModelStmt, err = db.PrepareContext(ctx, updateSessionAgentAndModel); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateSessionAgentAndModel: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.updateSessionAgentAndModelStmt != nil {
		if cerr := q.updateSessionAgentAndModelStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateSessionAgentAndModelStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	updateSessionAgentAndModelStmt       *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		updateSessionAgentAndModelStmt:       q.updateSessionAgentAndModelStmt,
