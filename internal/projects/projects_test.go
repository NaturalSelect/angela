...
func TestRegisterAndList(t *testing.T) {
	...
	if projects[0].DataDir != "/home/user/project1/.angela" {
		t.Errorf("Expected data_dir /home/user/project1/.angela, got %s", projects[0].DataDir)
	}

	// Register another project
	err = Register("/home/user/project2", "/home/user/project2/.angela")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestRegisterUpdatesExisting(t *testing.T) {
	...
	err = Register("/home/user/project1", "/home/user/project1/.angela-new")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/project1/.angela-new" {
...
func TestRegisterWithParentDataDir(t *testing.T) {
	...
	err := Register("/home/user/monorepo/packages/app", "/home/user/monorepo/.angela")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/monorepo/.angela" {
		t.Errorf("Expected data_dir /home/user/monorepo/.angela, got %s", projects[0].DataDir)
	}
}
...
func TestRegisterWithExternalDataDir(t *testing.T) {
	...
	err := Register("/home/user/project", "/var/data/angela/myproject")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/var/data/angela/myproject" {
		t.Errorf("Expected data_dir /var/data/angela/myproject, got %s", projects[0].DataDir)
	}
}
