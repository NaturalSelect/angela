...
func TestMarshalUnmarshalPartsRoundTrip(t *testing.T) {
	...
	parts := []proto.ContentPart{
		...
		proto.Finish{Reason: proto.FinishReasonToolUse, Time: 5000, Message: "done", Details: "all good", OutputTokens: 256, GenDurationMs: 7890, InputTokens: 300, CacheReadTokens: 150, CacheCreationTokens: 50},
