...
func (c *scriptedCoordinator) LockSession(context.Context, string) (func(), bool) { return nil, false }
...
func (c *scriptedCoordinator) IsSessionBranch(string) bool                     { return false }
...
func (c *scriptedCoordinator) AskSideQuestion(context.Context, string, string) (string, error) {
	return "", nil
}

func (c *scriptedCoordinator) GenerateCommitMessage(context.Context, string, string) (string, error) {
	return "", nil
}
