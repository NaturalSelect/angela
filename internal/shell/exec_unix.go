...
// fully detached from Angela's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Angela's process
// group.
...
// from Angela's session and controlling terminal.
//
