...
const docTemplate = `{
    ...
    "info": {
        ...
        "license": {
            "name": "MIT",
            "url": "https://github.com/NaturalSelect/angela/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
    ...
    "paths": {
        ...
        "/workspaces/{id}/agent/active-agent": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/workspaces/{id}/agent/sessions/{sid}/abandon-branch": {
            "post": {
                "tags": [
                    "agent"
                ],
        ...
        "/workspaces/{id}/agent/sessions/{sid}/active-agent": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/workspaces/{id}/agent/sessions/{sid}/side-question": {
            "post": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/workspaces/{id}/config/prune-recent-models": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Prune recent models request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/workspaces/{id}/config/recent-model": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_NaturalSelect_angela_internal_proto.Message"
                            }
                        }
                    },
                    "404": {
        ...
        "/workspaces/{id}/sessions/{sid}/undo": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Cut message ID from a prior preview",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "config.Agent": {
            ...
            "properties": {
                "allowed_agents": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.AllowedAgentSet"
                        }
                    ]
                },
                "allowed_mcp": {
        ...
        "github_com_NaturalSelect_angela_internal_config.Scope": {
            "type": "integer",
            "enum": [
                0,
                1,
        ...
        "proto.ActiveAgentEditRequest": {
            ...
            "properties": {
                "agent": {
                    "description": "Agent, when non-empty, re-instantiates the session on a\ndifferent primary agent.",
                    "type": "string"
                },
                "model": {
                    "$ref": "#/definitions/config.SelectedModel"
        ...
        "proto.UndoPreview": {
            ...
            "properties": {
                "cut_message_id": {
                    "description": "CutMessageID identifies the turn: it is the earliest message\nUndo would remove, and must be passed back to Undo unchanged.",
                    "type": "string"
                },
                "delete": {
                    "type": "array",
        ...
        "proto.Workspace": {
            ...
            "properties": {
                ...
                "config": {
                    "$ref": "#/definitions/github_com_NaturalSelect_angela_internal_config.Config"
                },
                "data_dir": {
                    "type": "string"
                },
